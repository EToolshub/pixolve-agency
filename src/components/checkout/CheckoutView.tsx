    ...
    <Container className="py-16">
      ...
      <div className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-3">
        <form
          ...
          noValidate
          className="space-y-5 rounded-2xl border border-default p-6 sm:p-8 lg:col-span-2"
        >
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div>
              ...
              <input
                {...register("fullName")}
                className="w-full rounded-xl border border-input px-4 py-2.5 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
              />
              {errors.fullName && (
          ...
          <Button
            ...
            iconPosition="right"
          >
            Continuar: contarnos tu proyecto
          </Button>
          ...
          <div className="mt-4 space-y-1.5 border-t border-default pt-4 text-sm">
            {totalUnico > 0 && (
              <div className="flex justify-between">
                <span className="text-body">Pago único</span>
            ...
            {totalMensual > 0 && (
              <div className="flex justify-between">
                <span className="text-body">Mensual</span>
                <span className="font-semibold text-heading">
