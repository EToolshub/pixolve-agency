...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="pointer-events-none absolute -top-32 left-1/2 h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-gradient-to-br from-blue-200/60 to-sky-100/40 blur-3xl animate-blob" />

      <Container className="relative py-24 sm:py-32">
        <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-4 py-1.5 text-sm font-semibold text-blue-700 ring-1 ring-inset ring-blue-600/20">
            <Sparkles className="h-3.5 w-3.5" />
            Diseño, tecnología y estrategia en un solo lugar
          </span>

          <h1 className="text-balance mt-6 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
          ...
          <p className="text-balance mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-600">
